...
?>
    ...
    <div class="content">
        ...
        <div class="stats">
        	<ul> <li style="float:right;width:150px;"><a title="" class="count green" href="addproductpart.php">Add New</a></li>
               
            </ul>
            <div class="fix"></div>
        </div>
       <div class="table" style="margin-top: 10px;">
            <div class="head"><h5 class="iFrames">Part list</h5></div>
            <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
				...
				while($rows=mysqli_fetch_array($res)){
					$primary_id= clean($rows['part_id']);
			?>
                    <tr class="gradeA">
                        <td><?php echo clean($rows['part_name']);?></td>
                        <td><?php echo clean($rows['part_code']);?></td>
                      
                      
                        <td><input type="button" value="Edit" class="mws-button blue small" onclick="window.location.href='editproductpart.php?prodid=<?php echo base64_encode($primary_id);?>'" /></th>
					<td>
