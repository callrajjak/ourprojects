<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1">
            ...
            <link href="layout/styles/jquery.validity.css" rel="stylesheet" type="text/css"/>
            ...
            <script src="layout/scripts/jquery.validity.js" type="text/javascript"></script>
                <!--<script src="layout/scripts/jquery.min.js" type="text/javascript"></script>-->
    ...
    <body id="top">
        ...
        <div class="wrapper col#666666">
            ...
            <div class="wrapper col0">
                    <div id="topline">
                        <p>Tel: +91-22-2503 5973 &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp; eMail: info@kishorefarm.com</p>
<!--                        <ul>
                            <li><a href="index.php">Home</a></li>
                            <li class="last"><a href="#">Best Poultry Equipments in </a></li>
                        </ul>-->
                        <br class="clear" />
                    </div>
                </div>
